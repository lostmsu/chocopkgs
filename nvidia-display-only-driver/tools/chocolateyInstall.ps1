...
$packageArgs = @{
  packageName    = 'nvidia-display-only-driver'
  destination    = "${ENV:TEMP}\nvidiadriver" # Folder to extract drivers
  url64          = 'https://us.download.nvidia.com/Windows/516.40/516.40-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'dec17bcbd76113ce2c24dc95bc0904613f50925cc17ea0eee2c3471ad8454397'
